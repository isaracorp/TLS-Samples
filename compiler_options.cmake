...
if (("${CMAKE_C_COMPILER_ID}" MATCHES "Clang|GNU") AND ("${CMAKE_SYSTEM_NAME_LOWER}" MATCHES "linux|windows|cygwin"))
    set(CMAKE_C_LINK_FLAGS "-Wl,--no-as-needed ${CMAKE_C_LINK_FLAGS}")
endif ()
